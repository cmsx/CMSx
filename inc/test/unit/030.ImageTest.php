...
class ImageTest extends PHPUnit_Framework_TestCase
{
  ...
  function setUp()
  {
    $this->image        = DIR_TEST . '/resourse/1000x500.gif';
    $this->bike         = DIR_TEST . '/resourse/bike.jpg'; //Для водяных знаков
    $this->watermark    = DIR_TEST . '/resourse/magic.png';
    $this->path_to_save = DIR_TEMP . '/tests';
  }
  ...
  /** Необходимо проверять правильность обрезки вручную! */
  function testButCroppingCorners()
  {
    Image::Me($this->image)
      ->addResize(400, 300)
